...
export default function Slide2({ scale }: { scale: number }) {
  const imgSrc = "/assets/zatoka/river.jpg";
  return (
    <div
      ...
      >
        ...
        >
          ...
          <div className="flex flex-col justify-center flex-1">
            ...
            >
              First time on BlaBlaCar. He never replied. So I walked to the beach instead — a Spanish Water Dog trotted by, completely unbothered. That was enough to shift everything.
            </p>
          </div>
