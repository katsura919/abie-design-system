    ...
    >
      ...
      >
        ...
        <div className="flex flex-col justify-center flex-1" style={{ zIndex: 10, position: "relative" }}>
          ...
          >
            Lost my notebook. Found some clarity. Worth it.
          </p>
          ...
          <div style={{ marginTop: 56 }}>
            ...
            >
              <span style={{ fontFamily: MONO, fontSize: 22, letterSpacing: "0.15em", textTransform: "uppercase", color: "#f9f5f2", fontWeight: 400 }}>
                Follow for more →
              </span>
            </div>
          </div>
