    ...
    >
      ...
      >
        ...
        <div style={{ position: "absolute", inset: 0, zIndex: 0 }}>
          ...
          <div
            style={{
              ...
              inset: 0,
              background:
                "linear-gradient(to bottom, rgba(30,27,26,0.2) 0%, rgba(30,27,26,0.5) 45%, rgba(30,27,26,0.9) 100%)",
            }}
          />
        </div>
        ...
        <div className="flex flex-col justify-end flex-1" style={{ zIndex: 10, position: "relative" }}>
          ...
          >
            THE DETOUR{" "}
            <em style={{ fontFamily: SERIF, fontWeight: 400, fontStyle: "italic", textTransform: "lowercase", letterSpacing: 0, color: "var(--primary)" }}>
              was
            </em>{" "}
            THE POINT
          </h1>
          ...
          >
            A missed driver, a wrong bike, and a lost notebook — somehow became one of the clearest days in months.
          </p>
        </div>
