...
export default function Slide2({ scale }: { scale: number }) {
  const imgSrc = "/assets/zatoka/outside-smile-sideview.jpg";
  return (
    <div
        ...
        >
          ...
          <div className="flex flex-col justify-center flex-1">
            ...
            <div style={{ display: "flex", alignItems: "center", gap: 16, marginBottom: 28 }}>
              ...
              <span style={{ fontFamily: MONO, fontSize: 20, letterSpacing: "0.2em", textTransform: "uppercase", opacity: 0.6 }}>
                Philippines · 2022
              </span>
            </div>
            ...
            <div style={{ width: 40, height: 3, background: "var(--primary)", borderRadius: 2, margin: "24px 0" }} />
            ...
            >
              When survival is easy, ambition goes quiet. I watched myself stop pushing — and confuse convenience with progress.
            </p>
          </div>
