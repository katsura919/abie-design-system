...
export const meta = {
  id: "places-to-visit-in-madrid-spain-v2",
  title: "Places to Visit in Madrid Spain (v2)",
  topic: "Travel · Nomad Life",
...
export default function PlacesToVisitInMadridSpainV2Post() {
