...
export const meta = {
  id: "hidden-claude-features-nobody-talks-about",
  title: "Hidden Claude Features Nobody Talks About",
  topic: "AI & Workflows",
...
export default function HiddenClaudeFeaturesNobodyTalksAboutPost() {
