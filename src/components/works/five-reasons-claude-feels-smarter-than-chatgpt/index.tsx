...
export const meta = {
  id: "five-reasons-claude-feels-smarter-than-chatgpt",
  title: "5 Reasons Claude Feels Smarter Than ChatGPT",
  topic: "AI & Writing",
...
export default function FiveReasonsClaudeFeelsSmarterThanChatGPTPost() {
